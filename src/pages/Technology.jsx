    ...
    <>
      ...
      <section className="hero-section" style={{ minHeight: '60vh', paddingBottom: 'var(--space-6)' }}>
        <div className="container" style={{ zIndex: 2 }}>
          <span className="hero-eyebrow">[ SYSTEM_DESIGN_PLATFORM ]</span>
      ...
      <section style={{ backgroundColor: 'var(--color-surface-secondary)' }}>
        <div className="container">
          <div className="grid-2">
            ...
            <TechCard 
              title="01 / Embedded Intelligence"
            ...
            >
              Intelligence is not added to our machines at the end of the engineering cycle. It is architected in from the first design brief. Sensor arrays, real-time data processing, and adaptive systems are structural — not optional. The machine knows what the athlete needs before they do. <span className="system-code">ARRAY: 16-CHANNEL</span>
            </TechCard>

            <TechCard 
              title="02 / Advanced Materials"
              className="crosshair-card"
              icon={
                <svg className="tech-card-icon" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" style={{ width: '48px', height: '48px', marginBottom: 'var(--space-2)' }}>
              ...
              style={{ padding: 'var(--space-7)' }}
            >
              We do not select materials from standard catalogues. We evaluate materials against performance requirements and select for capability, not convention. Carbon composite layups, precision metallic alloys, next-generation polymers — each chosen because it is the right material for the specific load case, not the easiest to manufacture. <span className="system-code">COMPOSITE: 3K_MONOCOQUE</span>
            </TechCard>

            <TechCard 
              title="03 / Biomechanics Interface"
              className="crosshair-card"
              icon={
                <svg className="tech-card-icon" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" style={{ width: '48px', height: '48px', marginBottom: 'var(--space-2)' }}>
            ...
            <TechCard 
              ...
              style={{ padding: 'var(--space-7)' }}
            >
              Every component in a STIMULAI machine is designed as part of a system. We do not optimize components individually and hope they cohere. We define system-level performance requirements first, then engineer components to satisfy them. Performance is not additive. It is multiplicative. The system is the product. <span className="system-code">SYNERGY: 98.4%</span>
            </TechCard>
